...
from src.parameters import to_unconstrained, from_unconstrained
from src.parameters import ParameterSet, PropertySet
from src.types import PRNGKey, Scalar
from src.utils.utils import ensure_array_has_batch_dim
from src.utils.utils import rotate_subspace
    ...
    def fit_em(
        ...
        def em_step(params, m_step_state):
            ...
            params, m_step_state = self.m_step(params, props, batch_stats,
                                               ...
                                               block_ids, block_masks)
            return params, m_step_state, lp, lls.sum()
        ...
        for iter_num in pbar:
            params, m_step_state, lp, ll = em_step(params, m_step_state)
            total_lp = lp + ll
